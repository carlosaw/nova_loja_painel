    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="form-group <?php echo (in_array('bestseller', $errorItems))?'has-error':''; ?>">
          ...
          <label for="p_bestseller">Mais Vendidos</label>          
        </div>
        ...
        <div class="form-group <?php echo (in_array('new_product', $errorItems))?'has-error':''; ?>">
          ...
          <label for="p_new_product">Novo Produto</label>          
        </div>
        ...
        <button class="p_new_image btn btn-primary"><b>+ imagens</b></button><br/>
