...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header" style="background-color:transparent; color:rgb(0, 204, 255); font-size:16px; margin-left:25px;">MENU</li>
        ...
        <?php if( $viewData['user']->hasPermission('products_view') ): ?>
          <li class="<?php echo ($viewData['menuActive']=='products')?'active':''; ?>">
  ...
  <?php $this->loadViewInTemplate($viewName, $viewData); ?><!-- Content Header (Page header) -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Aw2Web</a>.</strong> Todos os direitos reservados.
  </footer>
